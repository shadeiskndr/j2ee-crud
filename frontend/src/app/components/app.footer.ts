    ...
    >
      <div class="flex justify-between items-center sm:flex-row flex-col gap-2">
        <div class="text-sm text-surface-600 dark:text-surface-400">
          2025 - Lonpac Insurance (Shahathir Iskandar)
        </div>
        <div class="flex gap-4">
          <a
            href="https://www.facebook.com/lonpacinsurancebhd/"
            target="_blank"
          ...
          <a
            href="https://github.com/shadeiskndr/j2ee-crud"
            target="_blank"
            rel="noopener noreferrer"
            class="text-surface-600 dark:text-surface-400 hover:text-primary transition-colors text-sm"
          >
